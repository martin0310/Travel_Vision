        ...
        <div class="page-container">
            <div class="container-fluid">
                ...
                <ul  class="cd-hero-slider mb-0 py-5">
                    <div style="text-align:center" class="d-flex position-relative tm-border-top tm-border-bottom intro-container" >
                        <div id="health_care_rank_d3" name="health_care_rank_d3"></div>
